...
def train_model(root_dir=None):
    main_dir = 'test_nb_x'
    main_dir = main_dir if root_dir == None else root_dir + '/' + main_dir
    ...
    t_ctx = Train_ctx(build_Conv2D_model_4x11, main_dir, l_ctx_a, max_run_time)
    # **************************************************
