...
from g15_new.unsorted_stuff.mask_tester import manhattan_heuristic, is_all_masks_ok, test_masks_14_ok
...
def need_exit(ctx=Ctx):
    ...
    if rsn == None and fnc.is_state_in_history(ctx): rsn = "state_in_history"
